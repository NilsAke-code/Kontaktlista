...
public static class ValidationHelper
{
    ...
    public static bool IsValidCity(string city)
    {
        ...
        // Detta är genererat av Chat GPT 4.0 - Jag använde mig utav ett HashSet för att lagra unika värden, för att validera enbart svenska städer. Listan täcker inte alla städer men :)

        return SwedishCities.Cities.Contains(city);
    }
}